defmodule Curve25519 do
  ...
  def calculate_exponent(x, exp, result \\ 1)
  def calculate_exponent(_x, 0, result), do: result
  def calculate_exponent(x, exp, result) do
    if band(exp, 1) == 1 do
      result = result * x
      x = rem(x * x, @prime)
  ...
  def mul_k_u(t, _k, _x_1, x_2, z_2, x_3, z_3, swap) when t == -1 do
  ...
  def mul_k_u(t, k, x_1, x_2, z_2, x_3, z_3, swap) do
    k_t = bsr(k, t) |> band(1)
